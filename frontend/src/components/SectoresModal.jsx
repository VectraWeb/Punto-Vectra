        ...
        <div style={{ background: C.creamDeep, borderRadius: '14px', padding: '16px', marginTop: '4px' }}>
          ...
          <div style={{ marginTop: '12px' }}>
            ...
            <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap', alignItems: 'center' }}>
              ...
              <input
                type="color"
                value={/^#[0-9a-fA-F]{6}$/.test(editing.color) ? editing.color : '#004d73'}
                onChange={e => updateSector(editing.id, { color: e.target.value })}
                title="Color personalizado"
                style={{
                  width: '36px', height: '36px', padding: 0, border: `3px solid ${editing.color === '#004d73' ? 'transparent' : C.espresso}`,
