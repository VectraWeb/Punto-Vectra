  ...
  return (
    <div style={{
        ...
        {mode === 'reserva' ? (
          ...
          <div style={{ padding: '0 0 40px' }}>
            ...
            <div style={{ padding: '0 20px', display: 'flex', flexDirection: 'column', gap: '14px' }}>
              {isClosedToday ? (
                <div style={{
                  padding: '24px 20px', background: '#fdf6e3', border: `1px solid ${C.soon}`,
                  borderRadius: '16px', textAlign: 'center', color: '#6b5a00', lineHeight: '1.5',
                }}>
                  <div style={{ fontSize: '15px', fontWeight: 700, marginBottom: '6px' }}>Estamos cerrados hoy</div>
                  <div style={{ fontSize: '13px' }}>No se pueden hacer reservas ni pedidos. Volvé mañana.</div>
                </div>
              ) : (
                <>
      ...
      <div style={{
        ...
        PuntoVectra · Sistema de gestión para restaurantes
      </div>
    </div>
  );
}